...
const PAPERS = [
  { id: "paper1", title: "Model Paper - 1", mcqCount: 20, timeMin: 10 },
  { id: "paper2", title: "Model Paper - 2", mcqCount: 25, timeMin: 12 },
];

export default function ModelPaperMenu({ route }) {
  const navigation = useNavigation();
  const { grade, level, stream, subject, mode = "model" } = route?.params || {};
