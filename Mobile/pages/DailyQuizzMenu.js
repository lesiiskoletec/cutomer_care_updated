...
const PAPERS = [
  { id: "paper1", title: "Daily Quiz Paper - 1", mcqCount: 20, timeMin: 10 },
  { id: "paper2", title: "Daily Quiz Paper - 2", mcqCount: 25, timeMin: 12 },
];

export default function DailyQuizMenu() {
  ...
  // ✅ NEW: Attempt Now button -> default Attempt 1
  const onAttemptNow = (paper) => onAttempt(paper, 1);

  return (
    <View style={styles.screen}>
      <Text style={styles.pageTitle}>Daily Quiz</Text>
      <Text style={styles.pageSub}>Choose a paper and start your attempt</Text>
      ...
      >
        {PAPERS.map((p) => (
          <View key={p.id} style={styles.card}>
            ...
            {/* ✅ MCQ + Minutes below title (center) */}
            ...
            {/* ✅ Attempt Now button BELOW attempts */}
            <Pressable
...
const styles = StyleSheet.create({
  ...
  /* ✅ Attempt Now button styles (same as previous) */
  btn: {
    marginTop: 12,
    height: 44,
    borderRadius: 14,
