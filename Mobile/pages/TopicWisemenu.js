...
const PAPERS = [
  { id: "paper1", title: "Topic Wise Paper - 1", mcqCount: 20, timeMin: 10 },
  { id: "paper2", title: "Topic Wise Paper - 2", mcqCount: 25, timeMin: 12 },
];

export default function TopicWiseMenu({ route }) {
  const navigation = useNavigation();

  const { grade, level, stream, subject, mode = "topicwise" } = route?.params || {};
  ...
  return (
    <View style={styles.screen}>
      <Text style={styles.pageTitle}>Topic Wise Papers</Text>
